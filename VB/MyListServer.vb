...
Namespace DXGrid_EF4_ServerMode
    Public Class MyListServer
        ...
        Private Function IListServer_GetUniqueColumnValues(ByVal expression As DevExpress.Data.Filtering.CriteriaOperator, ByVal maxCount As Integer, ByVal filterExpression As CriteriaOperator, ByVal includeFilteredOut As Boolean) As Object() Implements IListServer.GetUniqueColumnValues
